	...
	<section class="ftco-section d-flex align-items-center vh-100">
		<div class="container bg-body col-4 shadow">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group m-3">
	            	<button type="submit" class="form-control btn btn-primary rounded submit px-3"><a href="index.php?menu=listerEleve" class="text-white"> Connexion </a></button>
	            </div>
